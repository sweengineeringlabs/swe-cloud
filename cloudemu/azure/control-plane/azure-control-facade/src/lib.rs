...
use azure_control_spi::{CloudProviderTrait, Request as AzureRequest};
...
/// Create an Axum router for the Azure provider.
pub fn router(provider: Arc<AzureProvider>) -> Router {
    Router::new()
