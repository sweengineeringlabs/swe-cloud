...
(function(global) {
    ...
    const dom = {
        ...
        /**
         * Create a text node.
         * @param {number} textPtr - Pointer to text content
         * @param {number} textLen - Length of text content
         * @returns {number} - Element handle
         */
         ...
         * @param {number} valuePtr - Pointer to attribute value
         * @param {number} valueLen - Length of attribute value
         */
        setAttribute(handle, namePtr, nameLen, valuePtr, valueLen) {
         ...
         * @param {number} textLen - Length of text content
         */
        setTextContent(handle, textPtr, textLen) {
            const element = elementHandles.get(handle);
            if (element) {
    ...
    const events = {
         ...
         */
        addEventListenerDirect(targetHandle, eventTypePtr, eventTypeLen, callbackId) {
    ...
    const bindings = {
         ...
         * @param {number} eventTypePtr - Pointer to event type string
         * @param {number} eventTypeLen - Length of event type string
         */
        bindValue(elementHandle, signalHandle, eventTypePtr, eventTypeLen) {
            const element = elementHandles.get(elementHandle);
            const signal = elementHandles.get(signalHandle);
            ...
            const eventType = eventTypePtr && eventTypeLen > 0
                ? readString(eventTypePtr, eventTypeLen)
                : 'input';
