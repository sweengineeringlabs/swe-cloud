...
| **GCP** | 🟢 Active | Cloud Storage, Pub/Sub, Firestore, Secret Manager, Monitor, Eventarc, Identity, KMS, Workflows |
...
├── crates/
│   ├── cloudkit_spi/             # Foundation (Errors, Types, Context)
│   ├── cloudkit_api/             # API Contracts (Service Traits)
│   ├── cloudkit_core/            # Orchestration Logic
│   ├── cloudkit/                 # Facade (Public API)
