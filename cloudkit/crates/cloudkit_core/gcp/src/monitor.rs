            ...
            for series in series_list {
                if let Some(points) = series.points {
                    for p in points {
                        ...
                        if let Ok(_ts) = DateTime::parse_from_rfc3339(&p.interval._end_time) {
...
mod tests {
    ...
    async fn test_monitor_flow() {
        ...
        let query = MetricQuery {
            ...
            period_seconds: 60,
            statistic: cloudkit_api::MetricStatistic::Average,
            dimensions: std::collections::HashMap::new(),
        };
        ...
        let log_events = vec![
            LogEvent {
                ...
                timestamp: Utc::now(),
                level: cloudkit_api::LogLevel::Info,
                fields: std::collections::HashMap::new(),
            },
            LogEvent {
                message: "Test log message 2".to_string(),
                timestamp: Utc::now(),
                level: cloudkit_api::LogLevel::Warn,
